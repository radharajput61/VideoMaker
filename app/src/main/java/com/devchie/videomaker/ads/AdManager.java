...
//    }
    ...
    public static void maxBanner(Activity activity, LinearLayout linearLayout) {
        ...
        maxAdView.setBackgroundColor(activity.getResources().getColor(R.color.colorPrimary));
    ...
    public static void maxBannerAdaptive(Activity activity, LinearLayout linearLayout) {
        ...
        // Set background or background color for banners to be fully functional
        maxAdAdaptive.setBackgroundColor(activity.getResources().getColor(R.color.colorPrimary));
