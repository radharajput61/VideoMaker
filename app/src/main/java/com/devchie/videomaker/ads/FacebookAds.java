...
//            });
    ...
    public static void loadFullAdStart() {
        if (interstitialAdStart != null) {
            ...
            addTestDevice("7e852746-0142-4639-8afe-94240cc38d86");
...
//            });
    ...
    public static void loadBanner(final Activity activity) {
        ...
        AdView adView = new AdView((Context) activity, activity.getString(R.string.facebook_banner_id), AdSize.BANNER_HEIGHT_90);
